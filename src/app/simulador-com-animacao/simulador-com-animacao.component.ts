...
@Component({
  ...
  templateUrl: './simulador-com-animacao.component.html',
  styleUrls: ['./simulador-com-animacao.component.css']
})
export class SimuladorComAnimacaoComponent implements OnInit {
