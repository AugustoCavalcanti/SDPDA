...
@Component({
  ...
  templateUrl: './simulador-sem-animacao.component.html',
  styleUrls: ['./simulador-sem-animacao.component.css']
})
export class SimuladorSemAnimacaoComponent implements OnInit {
